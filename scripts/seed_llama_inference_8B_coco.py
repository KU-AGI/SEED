...
def make_coco_caption_input_tokens(img_tokens):
    return tokenizer.bos_token + s_token + "USER: " + img_tokens + 'Please provide an accurate and concisedescription of the given image.: ASSISTANT: ' + sep + e_token
