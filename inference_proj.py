...
class SEEDTrainingWrapper(LightningModule):
    ...
    def validation_step(self, batch, batch_idx: int, save_path=None):
        ...
        with torch.no_grad():
            ...
            if self.validation_image_folder is None:
                ...
                save_path = self.validation_image_folder
    ...
    def on_validation_epoch_end(self):
        ...
        if self.validation_image_folder is None:
            ...
            generated_image_dir = self.validation_image_folder
...
if __name__ == "__main__":
    ...
    checkpoint_path = '/home/zheedong/Projects/SEED/logs/seed_stage2_proj/lightning_logs/projection/checkpoints/epoch=9-step=1960.ckpt'
    wrapper = SEEDTrainingWrapper.load_from_checkpoint(checkpoint_path, cfg=cfg, validation_image_folder='/ssd0/checkpoints/seed_tokenizer/results/proj').to(device)
    wrapper.setup("fit")
