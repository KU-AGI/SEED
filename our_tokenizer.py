...
class SEEDTrainingWrapper(LightningModule):
    ...
    def __init__(self, cfg):
        ...
        if self.fp16:
            ...
            self.image_tokenizer.model = self.image_tokenizer.model.half()
    ...
    def get_causal_embeddings(self, image):
        ...
        with torch.no_grad():
            # [b, 257, 1408]
            image_embeds = self.image_tokenizer.model.ln_vision(self.image_tokenizer.model.visual_encoder(image))
            # [b, 256]
