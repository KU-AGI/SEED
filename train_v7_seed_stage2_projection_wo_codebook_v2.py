...
class SEEDTrainingWrapper(LightningModule):
    ...
    def get_stage2_quant(self, img, is_bypass_codebook=False):
    ...
    def get_stage_2_loss_wo_codebook(self, batch, batch_idx: int, is_validation=False):
        """_summary_
    ...
    def training_step(self, batch, batch_idx: int):
        ...
        stage_2_loss = self.get_stage_2_loss_wo_codebook(batch, batch_idx)
...
if __name__ == "__main__":
    ...
    checkpoint_path = '/home/ubuntu/Projects/SEED_Tokenizer/logs/seed_stage_1_training_debug_aica/lightning_logs/version_21_BLIP_init_normalize_fixed_10epoch/checkpoints/epoch=9-step=2780.ckpt'
