...
class SEEDTrainingWrapper(LightningModule):
    ...
    def validation_step(self, batch, batch_idx: int):
        ...
        reconstructed_images = self.image_tokenizer.decode(indices)
        tensor_images = []
    ...
    def configure_optimizers(self):
        ...
        scheduler = transformers.get_linear_schedule_with_warmup(optimizer=optimizer, num_warmup_steps=500, num_training_steps=3300)
