...
class SlotTrainingWrapper(LightningModule):
    ...
    def __init__(self, cfg):
        ...
        if self.stage == 1:
            # TODO : Hard coded. 1024 mean out size
            slot_embed = 1024
    ...
    def get_diffusion_loss(self, batch, batch_idx: int, is_validation=False):
        ...
        slots_1024 = self.apply_transformer(slots_1024, self.causal_blocks, use_causal_mask=True)
    ...
    def apply_transformer(self, slots, transformer_blocks, use_causal_mask=False):
    ...
    def get_quantize_loss(self, batch, batch_idx: int, is_validation=False):
        ...
        slots_1024_blocks_applied = self.apply_transformer(quant, self.blocks)
