...
from models.utils import CartesianPositionalEmbedding
...
class MultiHeadSTEVESA(ModelMixin, ConfigMixin):
    ...
    def __init__(self, num_iterations, num_slots, num_heads,
        ...
        self.num_slots = num_slots # 7 -> 32
        self.num_heads = num_heads # 1
        self.input_size = input_size # 768
        self.slot_size = slot_size # 768    
        self.mlp_hidden_size = mlp_hidden_size # 768
